...
class Body {
    ...
    assignParent(body) {
        this.setVX(Math.sqrt(G*body.getMass()/distance(this,body))*Math.cos(angle(this,body)+Math.PI/2));
        this.setVY(Math.sqrt(G*body.getMass()/distance(this,body))*Math.sin(angle(this,body)+Math.PI/2));
    }
}
...
bodies.push((new Planet(width/2 - 400, height/2, 0, 0, "gaseous", 30, 0, 125)));
...
/*
bodies.push(new Star(width*0.25, height*0.25, 1, 0, "orange"));
bodies.push(new Star(width*0.75, height*0.75, 1, Math.PI, "orange"));
for(let i = 0; i < 7; i++) {
    bodies.push(new Planet(bodies.at(0).getX() - 50*i - 100, bodies.at(0).getY(), Math.sqrt(G*bodies.at(0).getMass()/(50*i+100)), Math.PI/2, "rocky", 100+5*i, 0, 0));
    bodies.push(new Planet(bodies.at(0).getX() + 50*i + 100, bodies.at(0).getY(), Math.sqrt(G*bodies.at(0).getMass()/(50*i+100)), 3*Math.PI/2, "rocky", 0, 0, 100+5*i));
}
